...
import { Container, Row, Panel, Gallery, Column, Section, Description  } from './styles';
...
const WarrantySection = () => (
  <Section>
    ...
    <div>
      <span>
        <p className="title">Compra Garantida com Loren Ipsun</p>
        <p className="description">
          Receba o produto que esta eperando ou receba seu dinheiro
        </p>
      </span>
      <span>
